...
def _build_dimension_menu(menu_bar: QMenuBar, window: "MainWindow") -> None:
    ...
    _add_disabled(menu, "Linear")
    _add_disabled(menu, "Aligned")
    _add_disabled(menu, "Angular")
    _add_disabled(menu, "Radius")
    menu.addSeparator()
    _add_disabled(menu, "Style...")
    menu.addSeparator()
...
def _build_modify_menu(menu_bar: QMenuBar, window: "MainWindow") -> None:
    ...
    menu.addSeparator()
    _add_disabled(menu, "Trim")
    _add_disabled(menu, "Extend")
    _add_disabled(menu, "Offset")
    _add_disabled(menu, "Fillet")
    _add_disabled(menu, "Chamfer")
    _add_disabled(menu, "Explode")
    _add_disabled(menu, "Join")
    _add_disabled(menu, "Stretch")
    menu.addSeparator()
